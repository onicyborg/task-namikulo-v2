...
$(function () {
  ...
  $(".settingPanelToggle").on("click", function () {
    ...
    $(".main-wrapper, .main-content").on("click", function () {
  ...
  // Theme events disabled - handled by _base.blade.php inline JS for persistence

  // Theme persistence - initialized by server-side in _base.blade.php
  // Theme color switching handled by _base.blade.php inline JS
});
